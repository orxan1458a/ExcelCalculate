...
public class Memmedli_Hevva {
    List<Date> joinList=new ArrayList<>();
    List<Date>leftList=new ArrayList<>();

    public void hevva_list(int i, List<String> list) throws ParseException
    {


        if ("Joined".equals(list.get(i + 1)))
        {
            System.out.println("Memmedli Hevva qosuldu");
        ...
        {   System.out.println("Memmedli Hevva terk etdi");
            System.out.println(list.get(i+2));
    ...
    public void hevvaprint(int d11,int vaxt,int vaxt1)
    {int s=0;
    boolean sorgu=true;
        if (d11==0)
        {for (int i=0;i<leftList.size();i++)
        {
            ...
            if(sorgu==false){System.out.println("Hevvanin dersde istirak deqiqesi : "+(s+vaxt1-vaxt));}
            else System.out.println("Hevvanin dersde istirak deqiqesi : "+(vaxt1-vaxt));
        }
        ...
        else if(d11==1)
        {
          //  Date zengvaxti=new Date("3/5/2021, 09:59:00 AM\n");
            if((65+vaxt1-vaxt)!=65){
                ...
                if(sorgu==false)
                {
                    System.out.println("HEVVANIN DERSDE ISTIRAK DEQIQESI : " + (s + Excel1.zeng.getMinutes() + vaxt1 - vaxt));
                }
                ...
                else  System.out.println("HEVVANIN DERSDE ISTIRAK DEQIQESI : " + ( Excel1.zeng.getMinutes() + vaxt1 - vaxt));
            }else System.out.println("HEVVANIN DERSDE ISTIRAK DEQIQESI : 0...");
        }
    }
}
