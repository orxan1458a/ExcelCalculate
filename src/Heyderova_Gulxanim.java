...
public class Heyderova_Gulxanim {
    List<Date> joinList=new ArrayList<>();
    List<Date>leftList=new ArrayList<>();

    public void gulxanim_list(int i, List<String> list) throws ParseException
    {


        if ("Joined".equals(list.get(i + 1)))
        {
            System.out.println("Gulxanim qosuldu");
        ...
        {   System.out.println("Gulxanim terk etdi");
            System.out.println(list.get(i+2));
    ...
    public void gulxanimprint(int d3,int vaxt,int vaxt1)
    {int s=0;boolean sorgu=true;
        if (d3==0)
        {for (int i=0;i<leftList.size();i++)
        {
            ...
            if(sorgu==false){System.out.println("Gulxanimin dersde istirak deqiqesi : "+(s+vaxt1-vaxt));}
           else System.out.println("Gulxanimin dersde istirak deqiqesi : "+(vaxt1-vaxt));
        }
        ...
        else if(d3==1)
        {
            ...
            if ((65+vaxt1-vaxt)!=65){
                ...
                if(sorgu==false)
                {
                    System.out.println("GULXANIMIN DERSDE ISTIRAK DEQIQESI : " + (s + Excel1.zeng.getMinutes() + vaxt1 - vaxt));
                }
                ...
                else  System.out.println("GULXANIMIN DERSDE ISTIRAK DEQIQESI : " + ( Excel1.zeng.getMinutes() + vaxt1 - vaxt));
            }else System.out.println("GULXANIMIN DERSDE ISTIRAK DEQIQESI : 0...");
        }
    }
}
