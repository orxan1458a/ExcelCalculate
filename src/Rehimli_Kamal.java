...
public class Rehimli_Kamal {
    List<Date> joinList=new ArrayList<>();
    List<Date>leftList=new ArrayList<>();

    public void kamal_list(int i, List<String> list) throws ParseException
    {


        if ("Joined".equals(list.get(i + 1)))
        {
            System.out.println("Rehimli Kamal qosuldu");
        ...
        {   System.out.println("Rehimli Kamal terk etdi");
            System.out.println(list.get(i+2));
    ...
    public void kamalprint(int d10,int vaxt,int vaxt1)
    {int s=0;
    boolean sorgu=true;
        if (d10==0)
        {for (int i=0;i<leftList.size();i++)
        {
            ...
            if(sorgu==false){System.out.println("Kamalin dersde istirak deqiqesi : "+(s+vaxt1-vaxt));}
            else System.out.println("Kamalin dersde istirak deqiqesi : "+(vaxt1-vaxt));
        }
        ...
        else if(d10==1)
        {
          //  Date zengvaxti=new Date("3/5/2021, 09:59:00 AM\n");
            if((65+vaxt1-vaxt)!=65){
                ...
                if(sorgu==false)
                {
                    System.out.println("KAMAL DERSDE ISTIRAK DEQIQESI : " + (s + Excel1.zeng.getMinutes() + vaxt1 - vaxt));
                }
                ...
                else  System.out.println("KAMAL DERSDE ISTIRAK DEQIQESI : " + ( Excel1.zeng.getMinutes() + vaxt1 - vaxt));
            }else System.out.println("KAMAL DERSDE ISTIRAK DEQIQESI : 0...");
        }
    }
}
