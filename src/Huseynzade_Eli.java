...
public class Huseynzade_Eli {
    List<Date> joinList=new ArrayList<>();
    List<Date>leftList=new ArrayList<>();

    public void eli_list(int i, List<String> list) throws ParseException
    {


        if ("Joined".equals(list.get(i + 1)))
        {
            System.out.println("Hüseynzadə Əli qosuldu");
        ...
        {   System.out.println("Hüseynzadə Əli terk etdi");
            System.out.println(list.get(i+2));
    ...
    public void eliprint(int d2,int vaxt,int vaxt1)
    {int s=0;
    boolean sorgu=true;
        if (d2==0)
        {for (int i=0;i<leftList.size();i++)
        {
            ...
            if(sorgu==false){System.out.println("Elinin dersde istirak deqiqesi : "+(s+vaxt1-vaxt));}
            else System.out.println("Elinin dersde istirak deqiqesi : "+(vaxt1-vaxt));
        }
        ...
        else if(d2==1)
        {
            ...
            if((65+vaxt1-vaxt)!=65){
                ...
                if(sorgu==false)
                {
                    System.out.println("ELININ DERSDE ISTIRAK DEQIQESI : " + (s + Excel1.zeng.getMinutes() + vaxt1 - vaxt));
                }
                ...
                else  System.out.println("ELININ DERSDE ISTIRAK DEQIQESI : " + ( Excel1.zeng.getMinutes() + vaxt1 - vaxt));
            }else System.out.println("ELININ DERSDE ISTIRAK DEQIQESI : 0...");
        }
    }
}
