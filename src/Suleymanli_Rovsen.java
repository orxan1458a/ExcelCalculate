...
public class Suleymanli_Rovsen {
    List<Date> joinList=new ArrayList<>();
    List<Date>leftList=new ArrayList<>();

    public void suleymanli_list(int i, List<String> list) throws ParseException
    {


        if ("Joined".equals(list.get(i + 1)))
        {
            System.out.println("Süleymanlı Rövşən qosuldu");
        ...
        {   System.out.println("Süleymanlı Rövşən tərk etdi");
            System.out.println(list.get(i+2));
    ...
    public void suleymanliprint(int d14,int vaxt,int vaxt1)
    {int s=0;
    boolean sorgu=true;
        if (d14==0)
        {for (int i=0;i<leftList.size();i++)
        {
            ...
            if(sorgu==false){System.out.println("Suleymanli Rovsenin dersde istirak deqiqesi : "+(s+vaxt1-vaxt));}
           else System.out.println("Suleymanli Rovsenin dersde istirak deqiqesi : "+(vaxt1-vaxt));
        }
        ...
        else if(d14==1)
        {
          //  Date zengvaxti=new Date("3/5/2021, 09:59:00 AM\n");
            if((65+vaxt1-vaxt)!=65)
            {
                ...
                if(sorgu==false)
                {
                    System.out.println("SULEYMANLI ROVSENIN DERSDE ISTIRAK DEQIQESI : " + (s + Excel1.zeng.getMinutes() + vaxt1 - vaxt));
                }
                ...
                else  System.out.println("SULEYMANLI ROVSENIN DERSDE ISTIRAK DEQIQESI : " + ( Excel1.zeng.getMinutes() + vaxt1 - vaxt));
            }else System.out.println("SULEYMANLI ROVSENIN DERSDE ISTIRAK DEQIQESI : 0...");
        }
    }
}
